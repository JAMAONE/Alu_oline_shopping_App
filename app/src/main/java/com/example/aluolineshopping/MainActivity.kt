...
class MainActivity : AppCompatActivity() {
    ...
    //Declaration of shoppingAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //loads shopping which contains product's name, description, and it image
